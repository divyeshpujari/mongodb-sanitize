...
const { sanitize, isSanitized, sanitizeMiddleWare } = require('./index');
...
describe('Test the mongodb-sanitize', () => {
  ...
  /**
   * @description Test-suit to test the various object/array is sanitized middleware.
   *
   * @author Divyeshkumar Pujari
   * @method isSanitized
   */
